  ...
  init: function (start) {
    if (start != 0){
      ...
      if (i !== -1) {
        ...
        S.UI.simulate('|#countdown 3||致|可亲的|貌美的|周妈妈：|三尺讲台|仰慕您|无所不知|口若悬河的|激情澎湃|饭前课后|感动于|一句一句|细致入微的|体贴关照|真想|上百尺危楼|摘下星星|为您庆贺|真想|离太阳更近|放声高歌|为您祝福：|周妈妈|生日快乐！|北棠阁学子|全体敬上|北棠阁');
      }
